...
public class BirthdayCakeProblem {
    // find max number of occurrences of max height candle.
    public static void main(String[] args) {
        List<Integer> myList = Arrays.asList(1,1,2,3,9,9,9,9,3,3,4);
    ...
    public static int birthdayCakeCandles(List<Integer> candles) {
        ...
        for (Map.Entry<Integer, Integer> myEntrySet : candleMap.entrySet()) {
            if(myEntrySet.getValue() > maxValue) {
                maxValue = myEntrySet.getValue();
            }
        }
